...
class CouncilParams:
    ...
    def create(
        self,
        args: tuple[str | bytes, int] | CreateArgs,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> algokit_utils.AppCallMethodCallParams:
        method_args = _parse_abi_args(args)
        params = params or algokit_utils.CommonAppCallParams()
...
class CouncilClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["create(account,uint64)void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
...
class CouncilFactoryCreateParams:
    ...
    def create(
        ...
        *,
        ...
        """Creates a new instance using the create(account,uint64)void ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
    ...
    def create(
        ...
        *,
        ...
        compilation_params: algokit_utils.AppClientCompilationParams | None = None
            ...
            """Creates and sends a transaction using the create(account,uint64)void ABI method"""
            params = params or algokit_utils.CommonAppCallCreateParams()
