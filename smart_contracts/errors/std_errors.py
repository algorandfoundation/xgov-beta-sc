...
ALREADY_XGOV = "Already an active xGov"
NOT_XGOV = "Not an active xGov"
INVALID_VOTE = "Invalid vote"
MUST_BE_XGOV_OR_VOTING_ADDRESS = "Must be xgov or voting address"
...
COMMITTEE_STALE = "Committee is stale"
