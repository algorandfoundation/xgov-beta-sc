...
from ..common.abi_types import MetadataHash
...
class XgovRegistryMock(ARC4Contract):
    def __init__(self) -> None:
        ...
        self.committee_id = GlobalState(
            MetadataHash.from_bytes(mock_cfg.COMMITTEE_ID),
    ...
    @arc4.abimethod()
    def set_committee_id(self, committee_id: MetadataHash) -> None:
        """
    ...
    def clear_committee_id(self) -> None:
        ...
        """
        self.committee_id.value = MetadataHash.from_bytes(mock_cfg.COMMITTEE_ID)
