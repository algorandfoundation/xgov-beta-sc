...
def test_finalize_success(
    ...
    xgov_backend_balance_before_finalize = algorand_client.account.get_information(  # type: ignore
        xgov_backend.address
    )[
        "amount"
    ]
    ...
    assert_account_balance(
        ...
        address=xgov_backend.address,
        expected_balance=xgov_backend_balance_before_finalize + publishing_fee,  # type: ignore
    )
