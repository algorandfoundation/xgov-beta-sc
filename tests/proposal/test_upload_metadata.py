...
#     composer.execute()
#
#     stored_payload = algorand_client.client.algod.application_box_by_name(
#     proposal_client.app_id, bMETADATA_BOX_KEY)[  # type: ignore
#         'value'
#     ]
#
#     stored_payload = b64decode(stored_payload)
#
#     assert stored_payload == payload
#
#     payload = dumps({'o': 'a' * 5000}).encode()
#
#     composer = proposal_client.compose()
#
#     for i in range((len(payload) // max_payload_size) + 1):
