...
| Return Proposal Commitment | Proposal Escrow | Proposer      |    Proposal Locked Deposit     | `finalize_proposal` (on xGov Registry) | Proposal is dropped for staleness   |
...
| Claim Voters MBR           | Proposal Escrow | xGov Treasury |         Voters Box MBR         | `finalize_proposal` (on xGov Registry) |                                     |
